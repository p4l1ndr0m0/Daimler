//
//  listadoTresViewController.swift
...
class listadoTresViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, HomeTresProtocal{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        // Retrieve cell
        let cellIdentifier: String = "cellTres"
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.performSegueWithIdentifier("segueMiercoles", sender: self)
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue?, sender: AnyObject?) {
        if (segue!.identifier == "segueMiercoles"){
            let detailVC  = segue!.destinationViewController as! t3ViewController
