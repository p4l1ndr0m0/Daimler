//
//  presentacionesViewController.swift
//  Daimler
//
...
class presentacionesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, HomeModelProtocal {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        // Retrieve cell
        let cellIdentifier: String = "presentacionCell"
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.performSegueWithIdentifier("seguePresentacion", sender: self)
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue?, sender: AnyObject?) {
        if (segue!.identifier == "seguePresentacion"){
            let detailVC  = segue!.destinationViewController as! vistaPresentacionesViewController
