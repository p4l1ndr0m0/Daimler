//
//  listadoAgendaViewController.swift
...
class listadoAgendaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, HomeUnoProtocal {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        // Retrieve cell
        let cellIdentifier: String = "cellLunes"
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.performSegueWithIdentifier("segueLunes", sender: self)
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue?, sender: AnyObject?) {
        if (segue!.identifier == "segueLunes"){
            let detailVC  = segue!.destinationViewController as! t1ViewController
